<div class="tab-pane fade" id="opposing-councel" role="tabpanel" aria-labelledby="opposing-councel-tab">
    @if(isset($legal_case->legalCaseOpposingCouncel))
    ...
    <a class="btn btn-primary btn-sm mb-3" id="phone-opposing-councel" href="tel:+1 {{ $legal_case->legalCaseOpposingCouncel->opposing_councel_phone ?? null }}">Phone</a>
    <button class="btn btn-primary btn-sm mb-3" id="email-opposing-councel" href="mailto:{{ $legal_case->legalCaseOpposingCouncel->opposing_councel_email ?? null }}">Email</button>
    @endif
